...
import { AnchorButton, Icon, Table, TableProps } from 'components';
import {Spinner} from "components/Spinner/moon";

import React, { useMemo } from 'react';
import { useTranslation } from 'translation';
import { VoteDetailTransaction } from 'types';
import { convertWeiToTokens, generateEvmosScanUrl } from 'utilities';
          ...
          action =
            voterTxs.to.toLowerCase() === address.toLowerCase() ? (
              <>
                ...
                {t('voterDetail.receivedMia')}
              </>
            ) : (
              <>
                <Icon name="arrowShaft" css={styles.sent} />
                {t('voterDetail.sentMia')}
              </>
            );
          ({ amountWei } = voterTxs);
        }
  ...
  return (
    <Paper css={styles.root} className={className}>
      ...
      <AnchorButton
        ...
        variant="secondary"
        href={generateEvmosScanUrl(address, 'address')}
      >
