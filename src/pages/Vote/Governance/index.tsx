...
import { Icon, Pagination, TextButton, Tooltip } from 'components';
...
const Governance: React.FC = () => {
  ...
  console.log("CURRENT VOTES ARE : "+currentVotesData?.votesWei);
  
  const { data: latestProposalData } = useGetLatestProposalIdByProposer(
    { accountAddress },
    { enabled: !!accountAddress },
  );
  console.log("LATEST PROPOSAL ID IS :"+ latestProposalData?.proposalId);
  ...
  console.log("LATEST PROPOSAL STATE IS :"+ latestProposalStateData?.state);
