...
import { useBorrowNToken, useGetUserMarketInfo } from 'clients/api';
...
const Borrow: React.FC<BorrowProps> = ({ asset, onClose, isMiaEnabled }) => {
  ...
  const { mutateAsync: borrow, isLoading: isBorrowLoading } = useBorrowNToken({
  ...
  const [limitTokens, safeLimitTokens] = React.useMemo(() => {
    ...
    const tokenDecimals = getToken(asset.id as NTokenId).decimals;
        ...
        <EnableToken
          ...
          tokenInfo={[
            ...
            },
            {
              ...
              iconName: 'mia',
              children: formatToReadablePercentage(asset.miaBorrowApy),
            },
          ]}
        >
          <BorrowForm
