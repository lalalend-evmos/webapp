...
const BorrowRepay: React.FC<BorrowRepayProps> = ({ onClose, asset, isMiaEnabled }) => {
  ...
  const tabsContent: TabContent[] = [
    {
      ...
      content: (
        <div css={styles.container}>
          <Repay asset={asset} onClose={onClose} isMiaEnabled={isMiaEnabled} />
        </div>
      ),
    },
  ];
  ...
  if (isAssetEnabled(asset.id)) {
    tabsContent.unshift({
      ...
      content: (
        <div css={styles.container}>
          <Borrow asset={asset} onClose={onClose} isMiaEnabled={isMiaEnabled} />
        </div>
      ),
    });
  }
