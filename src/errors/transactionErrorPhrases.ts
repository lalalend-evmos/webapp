...
export const transactionErrorPhrases: Record<
  ...
  | keyof typeof SebControllerErrorReporterError
  | keyof typeof SebControllerErrorReporterFailureInfo,
  string
> = {
  ...
  INSUFFICIENT_BALANCE_FOR_SEB: t('transactionErrors.insufficientBalanceForSeb'),
  ...
  SET_SEB_MINT_RATE_CHECK: t('transactionErrors.setSebMintRateCheck'),
  SET_SEBCONTROLLER_OWNER_CHECK: t('transactionErrors.setSebControllerOwnerCheck'),
  SET_MINTED_SEB_REJECTION: t('transactionErrors.setMintedSebRejection'),
  ...
  REPAY_SEB_COMPTROLLER_REJECTION: t('transactionErrors.repaySebComptrollerRejection'),
  REPAY_SEB_FRESHNESS_CHECK: t('transactionErrors.repaySebFreshnessCheck'),
  SEB_MINT_EXCHANGE_CALCULATION_FAILED: t('transactionErrors.sebMintExchangeCalculationFailed'),
  ...
  SEB_MINT_REJECTION: t('transactionErrors.sebMintRejection'),
  SEB_BURN_REJECTION: t('transactionErrors.sebBurnRejection'),
  SEB_LIQUIDATE_ACCRUE_BORROW_INTEREST_FAILED: t(
    'transactionErrors.sebLiquidateAccrueBorrowInterestFailed',
  ),
  SEB_LIQUIDATE_ACCRUE_COLLATERAL_INTEREST_FAILED: t(
    'transactionErrors.sebLiquidateAccrueCollateralInterestFailed',
  ),
  SEB_LIQUIDATE_COLLATERAL_FRESHNESS_CHECK: t(
    'transactionErrors.sebLiquidateCollateralFreshnessCheck',
  ),
  SEB_LIQUIDATE_COMPTROLLER_REJECTION: t('transactionErrors.sebLiquidateComptrollerRejection'),
  SEB_LIQUIDATE_COMPTROLLER_CALCULATE_AMOUNT_SEIZE_FAILED: t(
    'transactionErrors.sebLiquidateComptrollerCalculateAmountSeizeFailed',
  ),
  SEB_LIQUIDATE_CLOSE_AMOUNT_IS_UINT_MAX: t('transactionErrors.sebLiquidateCloseAmountIsUintMax'),
  SEB_LIQUIDATE_CLOSE_AMOUNT_IS_ZERO: t('transactionErrors.sebLiquidateCloseAmountIsZero'),
  SEB_LIQUIDATE_FRESHNESS_CHECK: t('transactionErrors.sebLiquidateFreshnessCheck'),
  SEB_LIQUIDATE_LIQUIDATOR_IS_BORROWER: t('transactionErrors.sebLiquidateLiquidatorIsBorrower'),
  SEB_LIQUIDATE_REPAY_BORROW_FRESH_FAILED: t(
    'transactionErrors.sebLiquidateRepayBorrowFreshFailed',
  ),
  SEB_LIQUIDATE_SEIZE_BALANCE_INCREMENT_FAILED: t(
    'transactionErrors.sebLiquidateSeizeBalanceIncrementFailed',
  ),
  SEB_LIQUIDATE_SEIZE_BALANCE_DECREMENT_FAILED: t(
    'transactionErrors.sebLiquidateSeizeBalanceDecrementFailed',
  ),
  SEB_LIQUIDATE_SEIZE_COMPTROLLER_REJECTION: t(
    'transactionErrors.sebLiquidateSeizeComptrollerRejection',
  ),
  SEB_LIQUIDATE_SEIZE_LIQUIDATOR_IS_BORROWER: t(
    'transactionErrors.sebLiquidateSeizeLiquidatorIsBorrower',
  ),
  SEB_LIQUIDATE_SEIZE_TOO_MUCH: t('transactionErrors.sebLiquidateSeizeTooMuch'),
