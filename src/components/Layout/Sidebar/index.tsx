...
import { ReactComponent as LogoNoText } from 'assets/img/miaLogoPure.svg';
import LogoDesktop from 'assets/img/lalalend.png';

import { Icon } from '../../Icon';
import ClaimMiaRewardButton from '../ClaimMiaRewardButton';
    ...
    <>
      ...
      <Drawer variant="permanent" css={styles.drawer}>
        <div css={styles.drawerContent}>
          <Toolbar css={styles.toolbar}>
            <img src={LogoDesktop} css={styles.logo}/>
            <img src={LogoDesktop} css={styles.logoClosed} height={60}/>
          </Toolbar>
      ...
      <div css={styles.mobileMenuBox}>
        <div css={styles.flexRow}>
          <img src={LogoDesktop} height={100}/>
        ...
        >
          ...
          <ClaimMiaRewardButton css={styles.claimMiaRewardButton} />
        </Menu>
      </div>
    </>
  );
