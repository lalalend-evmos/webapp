...
export type ProposalMaxOperationsUpdated = ContractEventLog<{
  oldMaxOperations: string;
  newMaxOperations: string;
  0: string;
  1: string;
}>;
...
export interface GovernorBravoDelegate extends BaseContract {
  ...
  methods: {
    ...
    miaVault(): NonPayableTransactionObject<string>;
  ...
  events: {
    ...
    ProposalMaxOperationsUpdated(
      cb?: Callback<ProposalMaxOperationsUpdated>
    ): EventEmitter;
    ProposalMaxOperationsUpdated(
      options?: EventOptions,
      cb?: Callback<ProposalMaxOperationsUpdated>
  ...
  once(
    event: "ProposalMaxOperationsUpdated",
    cb: Callback<ProposalMaxOperationsUpdated>
  ): void;
  once(
    event: "ProposalMaxOperationsUpdated",
