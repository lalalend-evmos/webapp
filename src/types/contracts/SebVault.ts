...
export interface SebVault extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  clone(): SebVault;
  methods: {
    _become(sebVaultProxy: string): NonPayableTransactionObject<void>;

    accMIAPerShare(): NonPayableTransactionObject<string>;
    ...
    miaBalance(): NonPayableTransactionObject<string>;

    pendingAdmin(): NonPayableTransactionObject<string>;

    pendingMIA(_user: string): NonPayableTransactionObject<string>;

    pendingRewards(): NonPayableTransactionObject<string>;

    pendingSEBVaultImplementation(): NonPayableTransactionObject<string>;

    seb(): NonPayableTransactionObject<string>;

    sebVaultImplementation(): NonPayableTransactionObject<string>;

    setMiaInfo(_mia: string, _seb: string): NonPayableTransactionObject<void>;
