...
export interface MiaVault extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  methods: {
    ...
    MIAAddress(): NonPayableTransactionObject<string>;

    MIAStore(): NonPayableTransactionObject<string>;

    _become(miaVaultProxy: string): NonPayableTransactionObject<void>;
    ...
    pendingMIAVaultImplementation(): NonPayableTransactionObject<string>;
